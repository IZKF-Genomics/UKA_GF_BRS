...
- Manifest dir: `/data/raw/.archive_manifests`
- Instrument allowlist:
  ...
  - `nextseq500_NB501289`
  - `novaseq_A01742`
- Run date source: run directory name prefix `YYMMDD_`
- Retention: keep recent 90 days; archive only runs strictly older than cutoff
...
- Use `--manifest-dir` or `--manifest-path` to point to a writable location when `/data/raw/.archive_manifests` is not writable.
