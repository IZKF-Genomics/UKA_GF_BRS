...
def _hostify(ctx, abs_local_path: Path) -> str:
    ...
    - Project mode: try to express the path relative to project.project_path's host/rest.
    - Ad-hoc mode (ctx.project is None): return hostname:/abs/local/path directly.
    """
