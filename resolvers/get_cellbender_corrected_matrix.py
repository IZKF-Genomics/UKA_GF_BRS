"""
Resolver: get_cellbender_corrected_matrix
Purpose: Return results/cellbender/cellbender_filtered.h5 for cellbender_remove_background
as a host-aware path.
"""
...
def main(ctx) -> str:
    ...
    out = base / "results" / "cellbender" / "cellbender_filtered.h5"
    if not out.is_file():
        raise RuntimeError(f"Expected corrected CellBender matrix not found: {out}")
